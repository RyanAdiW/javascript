var string = "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout."
...
console.log("Nomor 1:")
console.log(string.substr(8,16))
console.log("\n")
console.log("Nomor 2:")
